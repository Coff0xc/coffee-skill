...
`coffee-skill` 是一套面向 Codex 的技能包，覆盖软件工程、AI Agent/RAG、API/数据库、UI/文档输出、防御安全、检测响应、漏洞管理、身份安全、云与 DevSecOps、区块链安全、合规架构等工作流。
...
- 将 87 个来源 skill 合并为 15 个综合能力 skill，减少碎片化。
...
- 日常工程、AI 系统、文档报告、防御安全、安全运营、漏洞管理和培训实验环境。
